## script to select the most appropriate rhop for DoubletDecon runs by comparing to expected doublet numbers
...
##### Set up directories #####
dir <- "/path/to/output"
meta <- read_delim("/path/to/fibroblast_sample_meta.tsv", delim = "\t")
pools <- meta$Pool
